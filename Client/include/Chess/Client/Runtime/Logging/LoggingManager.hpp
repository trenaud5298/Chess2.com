#ifndef CHESS_CLIENT_RUNTIME_LOGGING_LOGGINGMANAGER_HPP
#define CHESS_CLIENT_RUNTIME_LOGGING_LOGGINGMANAGER_HPP
...
#include <Chess/Client/Runtime/Logging/LogHandler.hpp>
...
public:
    explicit LoggingManager(GameClient& gameClient);
    ~LoggingManager();
